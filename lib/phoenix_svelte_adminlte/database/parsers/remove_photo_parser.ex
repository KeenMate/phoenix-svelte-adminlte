...
defmodule PhoenixSvelteAdminlte.Database.Parsers.RemovePhotoParser do
  @moduledoc """
  ...
  @spec parse_remove_photo_result({:ok, Postgrex.Result.t()} | {:error, any()}) ::
          {:ok,
           [
             PhoenixSvelteAdminlte.Database.Models.RemovePhotoItem.t()
           ]}
          | {:error, any()}
  ...
  def parse_remove_photo_result_row([photo_id, code, original_filename, width, height, file_size]) do
    {
      :ok,
      %PhoenixSvelteAdminlte.Database.Models.RemovePhotoItem{
        photo_id: photo_id,
        code: code,
